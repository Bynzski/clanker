...
export function createElectronApiMock(overrides: Partial<ElectronApiMock> = {}): ElectronApiMock {
  return {
    ...
    resizeTerminal: createAsyncMock({ success: true }),
    killTerminal: createAsyncMock({ success: true }),
    ...
    browserHistoryAdd: createAsyncMock(true),
    browserHistoryClear: createAsyncMock(true),
